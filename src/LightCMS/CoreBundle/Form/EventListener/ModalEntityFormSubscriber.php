...
namespace LightCMS\CoreBundle\Form\EventListener;
...
class ModalEntityFormSubscriber implements EventSubscriberInterface
{
    ...
    public function __construct(ManagerRegistry $registry, $entity_class, $entity_repository, $entity_label)
    {
